...
eror = '🤷‍♂️*Результатов не найдено. Возможно фильма или сериала с таким названием нет или вы ввели название с ошибкой.*' \
       ...
       "\n" \
       "\n" \
       "_Задать вопросы или пообщаться можно в нашем чате_" + '👉 [Кино ЧатiKino | Фильмы 2020]' + "(https://t.me/joinchat/Ir-LFxcJ9ZVK2ld_p1vE_g)"
...
def send_welcome(message):
    ...
    try:
        mydb = mysql.connector.connect(host="ikino.cxutdxbu2lll.eu-west-2.rds.amazonaws.com",
                                       user='ikino_site', passwd='i06m50w3ohokodzw', database='mydatabase')
        ...
        mydb.commit()
        mydb.close()
        chri = "member" or chri = "creator" or chri = "administrator"
        try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            if len(data) <= 0:
                                ...
                                for i in data:
                                    if i['type'] == 'movie' and i['kinopoisk_id'] != 1049459 and i[
                                        'kinopoisk_id'] != 989978 and i['kinopoisk_id'] != 1055319 and i[
                                        'kinopoisk_id'] != 1183571 and i['kinopoisk_id'] != 1201533 and i[
                                        'kinopoisk_id'] != 1102923 and i['kinopoisk_id'] != 809823 and i[
                                        'kinopoisk_id'] != 1245524 and i['kinopoisk_id'] != 995075 and i[
                                        'kinopoisk_id'] != 1281638 and i['kinopoisk_id'] != 737900 and i[
                                        'kinopoisk_id'] != 1112920 and i['kinopoisk_id'] != 1371715:
