...
podptext = 'Привет друзья! Наш бот абсолютно бесплатен и без рекламы! Но доступ у него открыт только подписчикам нашего канала👉 '+ '[ФИЛЬМЫ И СЕРИАЛЫ]'+'(https://t.me/filmy)' \
            "\n" \
            "\n" \
...
def send_welcome(message):
    ...
    try:
        mydb = mysql.connector.connect(host="host="nbfj50setb1vgbjh.cbetxkdyhwsb.us-east-1.rds.amazonaws.com", user='ej4hz3lszccvek32', passwd='i06m50w3ohokodzw', database='d6idyikh5aoehxm1')
